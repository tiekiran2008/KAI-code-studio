...
export const FixSuggestionModal: React.FC<FixSuggestionModalProps> = ({
  ...
  }, [isOpen, showConfirmModal, showRunTestsModal, showCreateCommitModal, showPushBranchModal, showCreatePRModal, onClose]);
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-4 border-t border-slate-800 bg-slate-900/90">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-end">
            ...
            {/* Apply Suggestion Button (Available only after Accept, when not already Applied, and syntax is not invalid) */}
            {isAccepted && (
              <>
                {isApplied ? (
                  <>
